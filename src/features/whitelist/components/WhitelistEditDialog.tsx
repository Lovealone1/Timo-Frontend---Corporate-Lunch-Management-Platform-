...
export function WhitelistEditDialog({ isOpen, onClose, entry, onSave, isLoading }: WhitelistEditDialogProps) {
            ...
            <div className="w-full max-w-sm bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-xl animate-in fade-in zoom-in-95 duration-200">
                <div className="flex items-center justify-between p-6 border-b border-zinc-100 dark:border-zinc-800">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-lg font-bold text-zinc-900 dark:text-zinc-100">Editar Empleado</h2>
                            <p className="text-xs text-zinc-500">Cambiar información</p>
                        </div>
                    </div>
                    {!isLoading && (
